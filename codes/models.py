...
class VGG(nn.Module):
    ...
    VGG model
    """
    def __init__(self, features, input_dim, output_dim):
        super().__init__()
...
def VGG11(input_dim, output_dim):
    ...
    return VGG(make_layers(cfg['A']), input_dim, output_dim)
...
def BERT(input_dim, output_dim):
    PRETRAINED_LM = "bert-base-uncased"
    
    # return BertForSequenceClassification.from_pretrained(
    #     PRETRAINED_LM, num_labels=output_dim, output_attentions=False,
    #     output_hidden_states=False)

    return AutoModelForSequenceClassification.from_pretrained("bert-base-cased", num_labels=output_dim)
